...
open class LMDFloatingLabelTextField: UITextField {
    ...
    public var placeholderFont = UIFont.appLightFont(with: 16) {
        didSet {
            self.setNeedsLayout()
        }
    }
    ...
    fileprivate func setupViews() {
        ...
        self.notEditingConstraints = [
            NSLayoutConstraint(item: self.lmd_placeholder, attribute: .left, relatedBy: .equal, toItem: self, attribute: .left, multiplier: 1, constant: self.left_Padding),
    ...
    fileprivate func calculateEditingConstraints() {
        ...
        self.editingConstraints = [
            NSLayoutConstraint(item: self.lmd_placeholder, attribute: .left, relatedBy: .equal, toItem: self, attribute: .left, multiplier: 1, constant: -xOffset + self.left_Padding),
    ...
    override open func layoutSubviews() {
        ...
        self.layer.borderColor = self.error ? self.errorBorderColor?.cgColor : self.lmd_state == .editing ?
            ...
            UIColor(red: 112/255, green: 112/255, blue: 112/255, alpha: 1.0).cgColor
